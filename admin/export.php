<?php
session_start();
if(!isset($_SESSION['type']) || $_SESSION['type'] !='admin' || !isset($_SESSION['all_searched_patients'])) header('location:../index.php');

require('../resources/functions/helpers.php');

$all_patients_data = $_SESSION['all_searched_patients'] ;
